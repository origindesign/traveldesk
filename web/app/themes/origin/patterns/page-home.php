...
<div class="wp-block-group is-full-width-container is-style-client-list-wrapper fade-in">
	...
	<div class="wp-block-group is-style-client-list">
		...
		<!-- /wp:heading -->
		<!-- wp:group {"className":"is-style-client-list-internal","layout":{"type":"constrained"}} -->
		<div class="wp-block-group is-style-client-list-internal">
			<!-- wp:paragraph -->
			<p>european travel commission</p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p>Choice hotels</p>
			<!-- /wp:paragraph -->
